  ...
  return (
    <Modal visible={visible} animationType="slide" transparent>
      <View style={{ flex:1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0,0,0,0.35)' }}>
        <View style={{ width: '92%', backgroundColor: '#fff', borderRadius: 12, padding: 20, position: 'relative' }}>
          <TouchableOpacity style={{ position: 'absolute', right: 15, top: 15, zIndex:10 }} onPress={onClose} disabled={isLoading}>
          ...
          <TouchableOpacity style={{ alignItems: 'center', marginBottom: 18 }} onPress={handlePickImage} disabled={isLoading}>
            ...
            <Text style={{ fontSize: 12, color: '#888', marginTop: 8 }}>Tap to change profile picture</Text>
          </TouchableOpacity>
          ...
          <View style={{ marginBottom: 11 }}>
            ...
            <TextInput
              ...
              editable={false}
            />
            <Text style={{ fontSize: 12, color: '#888', marginTop: 2 }}>Email cannot be changed</Text>
          </View>
          <View style={{ marginBottom: 11 }}>
          ...
          <View style={{ marginBottom: 11 }}>
            ...
            <TextInput
              ...
              editable={!isLoading}
            />
            <Text style={{ fontSize: 12, color: '#888', alignSelf: 'flex-end', marginTop: 2 }}>{fields.bio.length}/200</Text>
          </View>
          <View style={{ flexDirection: 'row', marginTop: 14, marginBottom: 10 }}>
            <TouchableOpacity style={{ flex: 1, backgroundColor: '#eee', padding: 14, borderRadius: 8, marginRight: 6 }} onPress={onClose} disabled={isLoading}>
              <Text style={{ color: '#222', textAlign: 'center', fontWeight: '600' }}>Cancel</Text>
            </TouchableOpacity>
            <TouchableOpacity style={{ flex: 1, backgroundColor: '#333', padding: 14, borderRadius: 8, marginLeft: 6, alignItems: 'center', justifyContent: 'center' }}
              onPress={handleSaveProfile} disabled={isLoading}>
              {isLoading ? <ActivityIndicator color="#fff" /> : <Text style={{ color: '#fff', textAlign: 'center', fontWeight: '600' }}>Save Changes</Text>}
            </TouchableOpacity>
          </View>
        </View>
      </View>
