      ...
      >
        ...
        <View className="flex-1 px-6 pt-20 justify-between">
          ...
          <View className="mb-4">
            ...
            >
              <View className="flex-1">
                <Text className="text-base text-black/70 leading-5">
            ...
            >
              <Ionicons
                ...
                color="#000000"
              />
              <Text className="ml-2  text-base font-medium text-black/90">
                Need help using IronExSafe? See the quick app tour.
              </Text>
            </TouchableOpacity>
          </View>
        </View>
